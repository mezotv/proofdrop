...
export const uploadAssetInputShape = {
  ...
  key_prefix: z.string().min(1).optional().describe("Optional storage key prefix. Defaults to ASSET_KEY_PREFIX or 'proofdrop'."),
...
export const deleteAssetInputShape = {
  key: z.string().min(1).describe("Storage object key returned by upload_asset."),
};
